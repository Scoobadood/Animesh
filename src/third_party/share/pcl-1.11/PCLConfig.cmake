...
macro(find_eigen)
  ...
  elseif(NOT EIGEN_ROOT)
    get_filename_component(EIGEN_ROOT "/usr/local/Cellar/eigen/3.3.9/include/eigen3" ABSOLUTE)
  endif()
...
macro(find_flann)
  ...
  elseif(NOT FLANN_ROOT)
    set(FLANN_ROOT "/usr/local/Cellar/flann/1.9.1_9")
  endif()
...
macro(find_VTK)
  ...
  elseif(NOT VTK_DIR AND NOT ANDROID)
    set(VTK_DIR "/usr/local/lib/cmake/vtk-9.0" CACHE PATH "The directory containing VTKConfig.cmake")
  endif()
  if(NOT ANDROID)
...
elseif(EXISTS "${PCL_DIR}/include/pcl/pcl_config.h")
  ...
  set(PCL_SOURCES_TREE "/Users/dave/Animesh/dependencies/pcl")
else()
...
set(pcl_all_components  common kdtree octree search sample_consensus filters 2d geometry io features surface registration keypoints tracking)
