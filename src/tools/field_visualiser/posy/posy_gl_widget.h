...
class posy_gl_widget : public field_gl_widget {
 ...
 public:
  ...
  void render_lattice_positions(bool render) {
    if (m_render_lattice_positions == render) {
      return;
    }
    m_render_lattice_positions = render;
    update();
  }
 ...
 private:
  ...
  std::vector<float> m_lattice_positions;
  ...
  void maybeDrawLatticePositions() const;
  ...
  bool m_render_lattice_positions;
